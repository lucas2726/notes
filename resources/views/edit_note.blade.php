                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            {{-- value="{{ old("text_title", $note->title) }} : É usada para preencher um campo de formulário no Laravel, garantindo que, se houver um erro de validação, os dados que o usuário inseriu anteriormente sejam mantidos. --}}
                            {{-- show error --}}
                            @error('text_title')
